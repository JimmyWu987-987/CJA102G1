...
public class actImage {
	...
	private static void uploadImages(String folder, String sql) {
		try {
			// 取得專案路徑下的圖片資料夾
			File dir = new File("src/main/resources/static/images/act/" + folder);
			...
			Connection conn = DriverManager.getConnection(
					"jdbc:mysql://localhost:3306/farmtastic?useSSL=false&serverTimezone=Asia/Taipei", "root", PASSWORD);
