...
CREATE TABLE mem (
	...
	mem_mobile varchar(11) NOT NULL UNIQUE,
...
INSERT INTO PRO_ORDER (
	...
	PRO_ORD_SHIPDATE, PRO_ORD_NAME, PRO_ORD_MOBILE, PRO_ORD_EMAIL, PRO_ORD_ADDR
) VALUES
-- ===================================================================================================
-- MEM_ID 1: 謝維綺 (3 筆訂單 - FMEM_ID 1)
-- ===================================================================================================
(1, NULL, '2025-08-01 10:00:00', 3, 1, 950, 60, 50, 0, 10, 960, '請盡快出貨', 0, 0, 'SF10101010', '2025-08-03 09:00:00', '謝維綺', '0910-380143', 'pamela8508@gmail.com', '320桃園市中壢區仁和街35號'),
(1, NULL, '2025-08-03 16:30:00', 4, 1, 600, 60, 0, 0, 6, 660, NULL, 1, 1, '711A1010101', '2025-08-05 14:00:00', '謝維綺', '0910-380143', 'pamela8508@gmail.com', '320桃園市中壢區仁和街35號'),
(1, NULL, '2025-08-10 11:00:00', 1, 0, 400, 60, 0, 0, 0, 460, '轉帳完成通知', 1, 0, NULL, NULL, '謝維綺', '0910-380143', 'pamela8508@gmail.com', '320桃園市中壢區仁和街35號'),

-- ===================================================================================================
-- MEM_ID 2: 胡得軒 (3 筆訂單 - FMEM_ID 2)
-- ===================================================================================================
(2, NULL, '2025-08-01 14:00:00', 2, 1, 550, 60, 0, 0, 5, 610, NULL, 2, 1, 'FAMIB101010', '2025-08-02 11:00:00', '胡得軒', '0916-518593', 'henson1654@hotmail.com', '600嘉義市西區世賢路2段5號'),
(2, NULL, '2025-08-06 17:00:00', 1, 0, 300, 60, 100, 0, 0, 260, '請務必檢查數量', 0, 0, NULL, NULL, '胡得軒', '0916-518593', 'henson1654@hotmail.com', '600嘉義市西區世賢路2段5號'),
(2, NULL, '2025-08-15 09:30:00', 3, 1, 800, 60, 0, 0, 8, 860, NULL, 0, 0, 'SF20202020', '2025-08-17 14:00:00', '胡得軒', '0916-518593', 'henson1654@hotmail.com', '600嘉義市西區世賢路2段5號'), -- 修正: 850 -> 800 (Item總和)；910 -> 860 (實付)

-- ===================================================================================================
-- MEM_ID 3: 宋柯雯 (4 筆訂單 - FMEM_ID 3, 4, 5)
-- ===================================================================================================
(3, NULL, '2025-08-02 11:30:00', 3, 1, 1100, 60, 50, 100, 10, 1010, '黑豬肉請分裝', 0, 0, 'SF30303030', '2025-08-04 10:30:00', '宋柯雯', '0961-388330', 'arianna6146@hotmail.com', '511彰化縣社頭鄉中山路1段38號10樓之10'),
(3, NULL, '2025-08-08 10:00:00', 2, 1, 470, 0, 0, 0, 5, 470, '急件！', 3, 0, 'HMM11223344', '2025-08-09 15:00:00', '宋柯雯', '0961-388330', 'arianna6146@hotmail.com', '511彰化縣社頭鄉中山路1段38號10樓之10'), -- 修正: 570 -> 470 (Item總和)；570 -> 470 (實付)
(3, NULL, '2025-08-15 14:00:00', 0, 0, 450, 60, 0, 0, 0, 510, NULL, 1, 1, NULL, NULL, '宋柯雯', '0961-388330', 'arianna6146@hotmail.com', '511彰化縣社頭鄉中山路1段38號10樓之10'),
(3, NULL, '2025-08-16 16:00:00', 0, 0, 600, 60, 100, 0, 0, 560, '隔日轉帳', 1, 0, NULL, NULL, '宋柯雯', '0961-388330', 'arianna6146@hotmail.com', '511彰化縣社頭鄉中山路1段38號10樓之10'),

-- ===================================================================================================
-- MEM_ID 4: 郭實祐 (3 筆訂單 - FMEM_ID 1, 3, 4)
-- ===================================================================================================
(4, NULL, '2025-08-03 09:00:00', 4, 1, 1200, 0, 0, 0, 12, 1200, '退貨原因：數量錯誤', 3, 0, 'SF40404040', '2025-08-03 09:00:00', '郭實祐', '0937-453975', 'jeffrey2062@icloud.com', '360苗栗縣苗栗市宜春路62號'),
(4, NULL, '2025-08-09 13:30:00', 3, 1, 900, 60, 50, 0, 8, 910, NULL, 0, 1, '711B4040404', '2025-08-11 12:00:00', '郭實祐', '0937-453975', 'jeffrey2062@icloud.com', '360苗栗縣苗栗市宜春路62號'), -- 修正: 800 -> 900 (Item總和)；810 -> 910 (實付)
(4, NULL, '2025-08-12 17:00:00', 6, 1, 350, 60, 0, 0, 0, 410, '已退款', 0, 0, 'SF50505050', '2025-08-15 10:00:00', '郭實祐', '0937-453975', 'jeffrey2062@icloud.com', '360苗栗縣苗栗市宜春路62號'), -- 修正: 300 -> 350 (Item總和)；360 -> 410 (實付)

-- ===================================================================================================
-- MEM_ID 5: 林蓁蓓 (3 筆訂單 - FMEM_ID 2, 3, 4)
-- ===================================================================================================
(5, NULL, '2025-08-05 12:00:00', 5, 1, 600, 60, 0, 0, 0, 660, '已寄出退貨商品', 2, 1, 'POST50505050', '2025-08-07 15:00:00', '林蓁蓓', '0972-375934', 'kaylynn3676@hotmail.com', '803高雄市鹽埕區大成街98號'),
(5, NULL, '2025-08-13 09:30:00', 2, 1, 1000, 60, 50, 0, 10, 1010, NULL, 0, 0, 'SF60606060', '2025-08-14 11:00:00', '林蓁蓓', '0972-375934', 'kaylynn3676@hotmail.com', '803高雄市鹽埕區大成街98號'),
(5, NULL, '2025-08-17 15:00:00', 0, 0, 240, 60, 0, 0, 0, 300, '請於期限內付款', 1, 1, NULL, NULL, '林蓁蓓', '0972-375934', 'kaylynn3676@hotmail.com', '803高雄市鹽埕區大成街98號'),

-- ===================================================================================================
-- MEM_ID 6-20: 新增會員訂單 (每位 2-3 筆訂單，隨機分配 FMEM_ID 1-5)
-- ===================================================================================================
-- MEM_ID 6: 何俞維 (2 筆訂單 - FMEM_ID 5, 2)
(6, NULL, '2025-08-18 10:00:00', 3, 1, 450, 60, 0, 0, 4, 510, NULL, 0, 0, 'SF70707070', '2025-08-20 12:00:00', '何俞維', '0961-063659', 'hampden3392@gmail.com', '555南投縣魚池鄉日月街24號9樓之11'),
(6, NULL, '2025-08-22 14:00:00', 1, 1, 300, 60, 50, 0, 0, 310, '已付款待出貨', 0, 1, NULL, NULL, '何俞維', '0961-063659', 'hampden3392@gmail.com', '555南投縣魚池鄉日月街24號9樓之11'),

-- MEM_ID 7: 連之義 (2 筆訂單 - FMEM_ID 3, 1)
(7, NULL, '2025-08-25 15:30:00', 2, 1, 500, 60, 0, 0, 5, 560, NULL, 2, 0, 'POST778899', '2025-08-26 13:00:00', '連之義', '0915-476888', 'richards2316@gmail.com', '931屏東縣佳冬鄉民學路7號'),
(7, NULL, '2025-09-01 11:00:00', 3, 1, 800, 60, 100, 0, 7, 760, '超商取貨', 3, 1, '711C778899', '2025-09-03 16:00:00', '連之義', '0915-476888', 'richards2316@gmail.com', '931屏東縣佳冬鄉民學路7號'),

-- MEM_ID 8: 許洋竹 (2 筆訂單 - FMEM_ID 4, 3)
(8, NULL, '2025-09-03 17:00:00', 0, 0, 350, 60, 0, 0, 0, 410, NULL, 1, 0, NULL, NULL, '許洋竹', '0956-715009', 'mendoza8324@gmail.com', '803高雄市鹽埕區大勇市場5號'), -- 修正: 370 -> 350 (Item總和)；430 -> 410 (實付)
(8, NULL, '2025-09-05 10:30:00', 4, 1, 1000, 0, 50, 0, 9, 950, '已退貨申請', 0, 0, 'SF88990011', '2025-09-06 10:30:00', '許洋竹', '0956-715009', 'mendoza8324@gmail.com', '803高雄市鹽埕區大勇市場5號'),

-- MEM_ID 9: 陳婉術 (3 筆訂單 - FMEM_ID 1, 5, 4)
(9, NULL, '2025-09-08 14:30:00', 3, 1, 600, 60, 0, 0, 6, 660, NULL, 0, 1, 'FAMIC990011', '2025-09-10 12:00:00', '陳婉術', '0924-554240', 'evangeline3888@gmail.com', '110臺北市信義區信義路5段16號6樓之6'),
(9, NULL, '2025-09-12 16:00:00', 1, 0, 400, 60, 50, 0, 0, 410, '尚未付款', 1, 0, NULL, NULL, '陳婉術', '0924-554240', 'evangeline3888@gmail.com', '110臺北市信義區信義路5段16號6樓之6'),
(9, NULL, '2025-09-15 11:00:00', 2, 1, 350, 60, 0, 0, 3, 410, NULL, 2, 0, 'POST112233', '2025-09-16 14:00:00', '陳婉術', '0924-554240', 'evangeline3888@gmail.com', '110臺北市信義區信義路5段16號6樓之6'), -- 修正: 370 -> 350 (Item總和)；430 -> 410 (實付)

-- MEM_ID 10: 黃珍育 (2 筆訂單 - FMEM_ID 2, 3)
(10, NULL, '2025-09-18 09:00:00', 3, 1, 550, 60, 0, 0, 6, 610, NULL, 3, 1, '711D223344', '2025-09-20 10:00:00', '黃珍育', '0939-682988', 'debbie7435@outlook.com', '882澎湖縣望安鄉花嶼9號'),
(10, NULL, '2025-09-21 17:30:00', 1, 1, 400, 60, 50, 0, 4, 410, NULL, 0, 0, NULL, NULL, '黃珍育', '0939-682988', 'debbie7435@outlook.com', '882澎湖縣望安鄉花嶼9號'), -- 修正: 500 -> 400 (Item總和)；510 -> 410 (實付)

-- MEM_ID 11: 李大仁 (2 筆訂單 - FMEM_ID 4, 5)
(11, NULL, '2025-09-23 11:00:00', 3, 1, 370, 60, 0, 0, 6, 430, '請放管理室', 0, 0, 'SF99001122', '2025-09-25 09:00:00', '李大仁', '0911-222333', 'member001@example.com', '100台北市大安區信義路100號'), -- 修正: 590 -> 370 (Item總和)；650 -> 430 (實付)
(11, NULL, '2025-09-26 15:00:00', 2, 1, 450, 60, 0, 0, 5, 510, NULL, 2, 1, 'FAMID990011', '2025-09-27 15:00:00', '李大仁', '0911-222333', 'member001@example.com', '100台北市大安區信義路100號'),

-- MEM_ID 12: 王小美 (3 筆訂單 - FMEM_ID 1, 2, 3)
(12, NULL, '2025-09-28 10:00:00', 0, 0, 400, 60, 50, 0, 0, 410, NULL, 1, 0, NULL, NULL, '王小美', '0922-333444', 'member002@example.com', '221新北市板橋區中山路200號'),
(12, NULL, '2025-09-30 14:00:00', 3, 1, 600, 60, 0, 0, 6, 660, NULL, 0, 1, '711E887766', '2025-10-02 11:00:00', '王小美', '0922-333444', 'member002@example.com', '221新北市板橋區中山路200號'),
(12, NULL, '2025-10-01 16:30:00', 1, 1, 500, 60, 0, 0, 5, 560, '已出貨', 0, 0, NULL, NULL, '王小美', '0922-333444', 'member002@example.com', '221新北市板橋區中山路200號'),

-- MEM_ID 13: 張志豪 (2 筆訂單 - FMEM_ID 5, 4)
(13, NULL, '2025-10-03 11:30:00', 2, 1, 650, 60, 0, 0, 7, 710, '急需', 2, 0, 'POST334455', '2025-10-04 15:00:00', '張志豪', '0933-444555', 'member003@example.com', '401台中市北區學士路300號'),
(13, NULL, '2025-10-05 09:00:00', 0, 0, 350, 60, 50, 0, 0, 360, '尚未轉帳', 1, 1, NULL, NULL, '張志豪', '0933-444555', 'member003@example.com', '401台中市北區學士路300號'), -- 修正: 370 -> 350 (Item總和)；380 -> 360 (實付)

-- MEM_ID 14: 陳玉芬 (3 筆訂單 - FMEM_ID 1, 2, 5)
(14, NULL, '2025-10-06 14:30:00', 3, 1, 400, 60, 0, 0, 4, 460, NULL, 0, 1, 'FAMIE445566', '2025-10-08 11:00:00', '陳玉芬', '0944-555666', 'member004@example.com', '801高雄市前金區五福路88號'),
(14, NULL, '2025-10-09 16:00:00', 1, 1, 300, 60, 0, 0, 3, 360, NULL, 3, 0, NULL, NULL, '陳玉芬', '0944-555666', 'member004@example.com', '801高雄市前金區五福路88號'),
(14, NULL, '2025-10-10 10:00:00', 5, 1, 450, 60, 50, 0, 0, 460, '已退貨', 0, 0, 'SF11223344', '2025-10-12 15:00:00', '陳玉芬', '0944-555666', 'member004@example.com', '801高雄市前金區五福路88號'),

-- MEM_ID 15: 林建宏 (3 筆訂單 - FMEM_ID 3, 4, 1)
(15, NULL, '2025-10-11 15:00:00', 2, 1, 400, 60, 0, 0, 5, 460, '請注意包裝', 0, 0, 'SF55667788', '2025-10-12 17:00:00', '林建宏', '0955-666777', 'member005@example.com', '700台南市中西區民生路199號'), -- 修正: 500 -> 400 (Item總和)；560 -> 460 (實付)
(15, NULL, '2025-10-13 09:30:00', 3, 1, 600, 0, 100, 0, 4, 490, NULL, 2, 0, 'SF99001133', '2025-10-15 11:00:00', '林建宏', '0955-666777', 'member005@example.com', '700台南市中西區民生路199號'), -- 修正: 590 -> 600 (Item總和)；490 -> 490 (實付 - 剛好正確)
(15, NULL, '2025-10-15 16:00:00', 4, 1, 1500, 60, 0, 0, 15, 1560, '已申請退貨', 0, 1, '711F001122', '2025-10-17 14:00:00', '林建宏', '0955-666777', 'member005@example.com', '700台南市中西區民生路199號'),

-- MEM_ID 16: 曾雅婷 (2 筆訂單 - FMEM_ID 5, 2)
(16, NULL, '2025-10-16 10:30:00', 0, 0, 650, 60, 0, 0, 0, 710, NULL, 1, 0, NULL, NULL, '曾雅婷', '0966-777888', 'member006@example.com', '300新竹市東區光復路250號'),
(16, NULL, '2025-10-17 12:00:00', 3, 1, 300, 60, 50, 0, 2, 310, NULL, 0, 1, 'FAMIG002233', '2025-10-19 10:00:00', '曾雅婷', '0966-777888', 'member006@example.com', '300新竹市東區光復路250號'),

-- MEM_ID 17: 游信宏 (2 筆訂單 - FMEM_ID 3, 4)
(17, NULL, '2025-10-18 15:00:00', 2, 1, 500, 60, 0, 0, 5, 560, NULL, 2, 0, 'POST445566', '2025-10-19 18:00:00', '游信宏', '0977-888999', 'member007@example.com', '970花蓮縣花蓮市中正路10號'),
(17, NULL, '2025-10-20 09:00:00', 1, 0, 240, 60, 0, 0, 0, 300, '待轉帳', 1, 1, NULL, NULL, '游信宏', '0977-888999', 'member007@example.com', '970花蓮縣花蓮市中正路10號'),

-- MEM_ID 18: 洪詠欣 (2 筆訂單 - FMEM_ID 1, 5)
(18, NULL, '2025-10-21 11:00:00', 3, 1, 400, 60, 50, 0, 3, 410, NULL, 0, 1, '711H556677', '2025-10-23 11:00:00', '洪詠欣', '0988-999000', 'member008@example.com', '260宜蘭縣羅東鎮中山路一段88號'),
(18, NULL, '2025-10-24 16:30:00', 0, 0, 450, 60, 0, 0, 0, 510, NULL, 1, 0, NULL, NULL, '洪詠欣', '0988-999000', 'member008@example.com', '260宜蘭縣羅東鎮中山路一段88號'),

-- MEM_ID 19: 邱柏睿 (2 筆訂單 - FMEM_ID 2, 3)
(19, NULL, '2025-10-25 10:00:00', 3, 1, 300, 60, 0, 0, 3, 360, NULL, 0, 0, 'SF66778899', '2025-10-27 12:00:00', '邱柏睿', '0911-000222', 'member009@example.com', '600嘉義市西區垂楊路120號'),
(19, NULL, '2025-10-26 14:00:00', 1, 0, 600, 60, 100, 0, 0, 560, NULL, 1, 1, NULL, NULL, '邱柏睿', '0911-000222', 'member009@example.com', '600嘉義市西區垂楊路120號'),

-- MEM_ID 20: 簡心怡 (2 筆訂單 - FMEM_ID 4, 1)
(20, NULL, '2025-10-27 11:30:00', 2, 1, 600, 60, 0, 0, 6, 660, NULL, 2, 0, 'POST778890', '2025-10-28 15:00:00', '簡心怡', '0922-000333', 'member010@example.com', '540南投縣南投市中興路300號'), -- 修正: 590 -> 600 (Item總和)；650 -> 660 (實付)
(20, NULL, '2025-10-28 09:00:00', 3, 1, 300, 60, 50, 0, 3, 310, NULL, 0, 1, '711I889900', '2025-10-30 11:00:00', '簡心怡', '0922-000333', 'member010@example.com', '540南投縣南投市中興路300號'); -- 修正: 400 -> 300 (Item總和)；410 -> 310 (實付)
-- 刪除/建立 商城訂單明細
