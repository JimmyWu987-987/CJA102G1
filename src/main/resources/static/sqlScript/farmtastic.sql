...
('有機高麗菜(1顆)', 50, 1, 80, 1, 1, 5, 250, '屏東', '來自有機農場，口感清甜爽脆，通過嚴格驗證，無論清炒或入湯都美味，是您全家大小安心享用的健康蔬菜。'),
('無毒小黃瓜(1斤)', 30, 2, 80, 1, 1, 4, 180, '彰化', '堅持無毒農法栽種，保留小黃瓜的天然清甜與爽脆多汁，適合涼拌、沙拉或直接鮮食，感受田園的清新滋味。'),
('富士蘋果(1斤)', 120, 3, 100, 1, 2, 5, 300, '富士', '果肉細緻、香甜多汁，每一口都充滿濃郁果香與爽脆口感，是大人小孩都喜愛，送禮自用兩相宜的頂級水果。'),
('台灣香蕉(1斤)', 85, 4, 60, 1, 2, 4, 210, '屏東', '在地小農用心栽培，Q彈香甜的絕佳口感，富含天然果糖與營養，是補充能量、運動前後的最佳點心選擇。'),
('台東池上米(包)', 200, 5, 300, 1, 3, 5, 500, '台東', '來自台東縱谷的冠軍米，米粒晶瑩飽滿、口感Q彈，烹煮後香氣四溢，讓您品嚐來自純淨大地的原始好滋味。'),
('花蓮富里米(包)', 180, 6, 280, 1, 3, 4, 450, '花蓮', '吸收秀姑巒溪純淨水源灌溉，米飯香Q可口，黏度與甜度俱佳，每一口都吃得到花東縱谷最自然的甘甜米香。'),
('高山烏龍茶(200g)', 45, 7, 500, 1, 4, 5, 150, '南投', '精選台灣高海拔茶區，茶湯金黃清澈，喉韻甘醇、蘭花香氣清幽，是喜愛清香型茶品者不容錯過的絕佳選擇。'),
('金萱紅茶(200g)', 60, 8, 450, 1, 4, 4, 120, '南投', '特有品種台茶12號製成，茶湯呈現迷人琥珀色，帶有獨特的天然奶香與果香，口感溫潤滑順不苦澀。'),
('日曬香菇(1斤)', 90, 9, 120, 1, 5, 5, 200, '雲林', '遵循古法天然日曬，完整保留香菇的濃郁香氣與營養，口感Q彈厚實，是燉湯、滷肉、入菜的最佳提味幫手。'),
('新鮮杏鮑菇(1斤)', 75, 10, 85, 1, 5, 4, 190, '苗栗', '菌柄肥厚、口感紮實Q彈似鮑魚，味道清香鮮甜，無論是煎、烤、炒或煮湯，都能展現其百搭的獨特美味。'),
('龍眼蜜(1罐)', 110, 1, 450, 1, 6, 5, 100, '台中', '採集自龍眼花季的純淨蜂蜜，質地濃郁，帶有獨特的龍眼花香氣，滋味甜而不膩，是天然的養生滋補聖品。'),
('百花蜜(1罐)', 95, 2, 400, 1, 6, 4, 90, '台中', '匯集四季百花精華，蜜源豐富，口感清香淡雅，層次豐富，富含多種天然酵素與維生素，是您日常保健的首選。'),
('放牧雞蛋(1斤)', 250, 3, 120, 1, 7, 5, 350, '台南', '來自健康快樂的放牧雞，自由奔跑，蛋黃飽滿、色澤金黃，蛋白Q彈，口感香醇濃郁，每一口都吃得到營養。'),
('有機紅蘿蔔(1斤)', 70, 4, 75, 1, 1, 4, 160, '雲林', '有機農法栽種，根莖飽滿、色澤鮮豔，口感清甜爽脆，富含β-胡蘿蔔素，是守護家人健康的營養美味蔬菜。'),
('香水鳳梨(1斤)', 150, 5, 90, 1, 2, 5, 280, '宜蘭', '果肉纖維細緻，甜度高且帶有獨特香氣，風味濃郁多汁，一開箱便香氣四溢，讓您品嚐熱帶的甜蜜好滋味。'),
('有機糙米(包)', 190, 6, 250, 1, 3, 4, 420, '花蓮', '保留完整米糠與胚芽，膳食纖維豐富，口感扎實有嚼勁，是追求健康飲食、體內環保的最佳主食新選擇。'),
('文山包種茶(200g)', 55, 7, 480, 1, 4, 5, 130, '台中', '產自坪林茶區的特色條形茶，茶湯蜜綠，入口甘醇滑潤，帶有清新優雅的蘭花香氣，是品茗者的絕佳選擇。'),
('黑木耳(1斤)', 80, 8, 65, 1, 5, 4, 210, '新竹', '精選肉質肥厚的優質黑木耳，口感爽脆Q彈，富含膳食纖維與膠質，涼拌、快炒皆美味，是餐桌上的健康常客。'),
('紅心芭樂(1斤)', 100, 9, 50, 1, 2, 4, 230, '高雄', '在地嚴選的紅心土芭樂，果肉軟Q、香氣濃郁，富含茄紅素與維生素C，獨特的酸甜古早滋味讓人回味無窮。'),
('在地小番茄(1斤)', 140, 10, 70, 1, 2, 5, 260, '桃園', '小農新鮮直送的在地小番茄，皮薄多汁、酸甜可口，每一顆都充滿陽光的滋味，是開胃、解饞的天然零食。');
...
insert into act values
 ...
 '【環境沉浸與感官體驗】 參與者將親身捲起衣袖，解放雙腳，深入田間地表。赤足踏入泥濘的農地，透過直接的肢體接觸，感知土壤的質地與溫度，體驗最純粹的大地脈動。\n\n【農務操作與技能學習】\n在專業農人的指導下，體驗具備時序性的核心農務：親手進行水稻的「插秧」作業，或依據季節性安排「蔬果採摘」活動。透過汗水淋漓的勞動，理解作物生長週期與永續農業的實務操作。\n\n【活動流程】\n本次活動設計為高效率的60分鐘沉浸式體驗。首先（約10分鐘），進行田間導讀，由農業專家解說當季作物生態與農法原理；接著（約40分鐘），親身執行核心農事操作，著重於效率與深度體驗；最後（約10分鐘），安排產地鮮食試吃環節，讓參與者即時品嚐勞動成果，完成從田野到味蕾的完整感知旅程。\n\n活動主辦: 有機田園\n活動地點: 913 屏東縣萬丹鄉仁愛路一段100號\n連絡電話: 03-29123456\ne-mail: user001@example.com',
 200, 2, '2025-05-10 10:20:30', null, 1, '2025-05-15 09:20:30', 1, null, null, null),
-- 1:待審核 2:審核通過		     0: 下架 1:上架
-- 3: 審核未過 4:已編輯, 待審核
 
 /*審核未過*/
 (null, '從產地到餐桌的秘密', '2025-10-25','2026-03-31',
 '【環境沉浸與感官體驗】 \n參與者將透過互動遊戲和實境教學，連結日常飲食與農地生產。在輕鬆愉快的氛圍中，建立對不同食材的初步認知，開啟對食物來源的探索與好奇。\n\n【農務操作與技能學習】\n活動核心在於「知識轉化為行動」。透過農人指導的輕量化體驗，讓大小朋友親身參與農作物的種植或採集過程。藉由勞動的親身體驗，直觀理解食物的來之不易與生產者的辛勞。\n\n【活動流程】\n本次活動設計為高效率的60分鐘教育體驗。首先（約10分鐘），進行趣味性「食物小測驗」，激發參與興趣；接著（約40分鐘），親身操作簡易農事活動，或進行「從產地到餐桌」的教學遊戲，深化對食材來源的認識；最後（約10分鐘），以「惜食宣誓」或「創意食譜分享」環節作結，培養大小朋友對食物的珍視與永續利用的責任心。\n\n活動主辦: 有機田園\n活動地點: 913 屏東縣萬丹鄉仁愛路一段100號\n連絡電話: 03-29123456\ne-mail: user001@example.com',
 10000, 3, '2025-08-26 08:20:00', '報名費用有疑慮，請再次確認。', null, null, 1, null, null, null),
 
 /*到目前都正常上架&有人評價過*/
 (null, '小小牧場', '2025-03-15','2026-1-31',
 '【環境沉浸與感官體驗】\n參與者將身臨其境，走入充滿生機的牧場環境。透過溫和、安全的互動設計，近距離接觸可愛的溫馴動物，如親手餵食小羊、輕柔擁抱兔子等，開啟多層次的感官體驗與療癒連結。\n\n【農務操作與技能學習】\n活動核心著重於「責任感與生命教育」。在專業飼育員的指導下，學習動物的基本習性與照護知識。透過實際參與餵食、清潔與梳理毛髮等基礎牧場工作，理解動物福利的重要性，並體驗牧場日常運作的樂趣與挑戰。\n\n【活動流程】\n本次活動設計為高效率的沉浸式體驗。首先，進行牧場安全與動物習性講解，建立正確的互動觀念；接著，分組進行核心動物照護活動，包括定點餵食與親密抱抱時間；最後，安排「動物小知識問答」或「DIY牧場紀念品」環節，讓參與者帶著滿滿的歡樂與知識賦歸。\n\n活動主辦: 有機田園\n活動地點: 913 屏東縣萬丹鄉仁愛路一段100號\n連絡電話: 03-29123456\ne-mail: user001@example.com',
 399, 2, '2025-01-10 14:10:30', null, 1, '2025-01-15 16:00:30', 1, null, null, null),
 
 /*有人評價過此活動, 此活動已結束並下架*/
 (null, '藍染工藝體驗課程', '2024-12-01','2025-06-10',
 '【環境沉浸與感官體驗】\n參與者將親手進入天然染料的靛藍世界，在充滿植物香氣與手作溫度的空間中，感受藍染文化的沉靜與美好。透過視覺、嗅覺與觸覺的交互作用，體驗古老染色工藝的獨特魅力。\n\n【工藝操作與技能學習】\n活動核心著重於「技法傳承與創意實踐」。在專業職人的指導下，學習藍染的基礎原理、天然發酵與染液處理技巧。透過實際操作綁、縫、夾、染等技法，掌握天然染色工藝的精髓，並創作獨一無二的布藝作品。\n\n【活動流程】\n本次活動設計為高效率的沉浸式體驗。首先，進行藍染歷史與天然染料知識講解；接著，示範並指導基礎的絞染技法，讓參與者親手進行布料的前處理與浸染步驟；最後，協助作品展開、水洗與定色，並分享成果與交流創作心得。\n\n活動主辦: 有機田園\n活動地點: 913 屏東縣萬丹鄉仁愛路一段100號\n連絡電話: 03-29123456\ne-mail: user001@example.com',
 700, 2, '2024-10-27 19:10:30', '已修正金額，審核通過', 0, '2025-06-11 00:00:00', 1, null, null, null),
 
 /*審核已通過但還沒上架*/
 (null, '小村莊的故事之旅', '2025-10-01','2026-02-28',
 '【環境沉浸與感官體驗】\n\n參與者將跟隨專業導覽老師的腳步，漫步於傳統農村的巷弄與地景之間。透過聆聽、觀察與互動，深度感受在地生活脈動，將古老的歷史痕跡與淳樸的風俗文化，轉化為豐富的感官體驗。\n\n【文化學習與知識探索】\n\n活動核心著重於「歷史溯源與文化理解」。透過系統性的講解與實地考察，深度認識農村的開墾歷史、地方風俗、建築特色及節慶典故。引導參與者從文化角度理解農村的社會結構與價值觀，達成知識與心靈層面的探索。\n\n【活動流程】\n\n本次活動設計為高效率的沉浸式體驗。首先，由導覽老師進行農村地理與人文背景介紹；接著，實地走訪歷史建築、宗祠或特色聚落，並穿插故事講解與典故分享；最後，安排文化小物賞析或在地茶點體驗，為文化探索之旅畫下句點。\n\n活動主辦: 有機田園\n活動地點: 913 屏東縣萬丹鄉仁愛路一段100號\n連絡電話: 03-29123456\ne-mail: user001@example.com',
 299, 2, '2025-08-28 10:20:30', null, 0, null, 1, null, null, null),
 
 (null, '有機生活實踐：從產地到餐桌的農食之旅', '2025-12-01','2026-03-10',
 '【有機農務與土地體驗】\n親身參與有機田園的冬季農事，體驗「堆肥製作」與「土壤活化」等核心技術。在專業農人指導下，學習無毒耕作的原理與實作，理解土地與作物的共生關係。\n\n【食農教育與手作加工】\n親手採摘當季有機蔬果，並在田園廚房學習簡易的食物加工課程（例如：製作手工果醬或烘烤地瓜）。理解食物里程的概念，實踐從產地到餐桌的永續生活。\n\n【活動流程】\n本活動為單日深度體驗，每月舉辦一次。上午：有機農場導覽與當日農務實作體驗（約3小時）；中午：享用以採摘的有機食材烹煮的「田園午餐」；下午：農產品加工手作體驗與心得分享（約2小時）。\n\n活動主辦: 有機田園\n活動地點: 913 屏東縣萬丹鄉仁愛路一段100號\n連絡電話: 03-29123456\ne-mail: user001@example.com',
 1200, 2, '2025-10-1 11:30:00', null, 1, '2025-10-2 16:00:00', 1, null, null, null);
...
insert into ses values (null, '2025-08-08', '15:00', '17:30', '2025-08-01',  5, 20, 230, 0, '2025-08-08 17:30:00', 3, null, 1),
					   ...
					   /* 報名中 */                       
                       (null, '2025-11-20', '15:00', '16:00', '2025-10-20',  5, 15, 449, 1, '2025-08-05 00:00:00', 0, null, 3),
                       /* 場次取消 (10/7有地震導致部分設施要維修、直接取消) */
                       (null, '2025-10-10', '16:30', '17:30', '2025-10-01', 10, 20, 499, 0, '2025-10-07 00:00:00', 4, null, 1),
                       /* 圓滿結束 */
                       (null, '2025-06-05', '14:00', '16:30', '2025-05-25', 15, 30, 700, 0, '2025-06-30 00:00:00', 3, null, 4),
                       /* 成團, 活動尚未進行 */
                       (null, '2025-11-10', '14:00', '16:30', '2025-09-01',  5, 15, 200, 1, '2025-09-01 00:00:00', 1, null, 1);
