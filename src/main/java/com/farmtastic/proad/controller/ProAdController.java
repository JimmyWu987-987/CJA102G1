...
public class ProAdController {
    ...
    public String farmerApplyProAd(@ModelAttribute("proAdVO") ProAdVO proAdVO,
    ...
    public String showFarmerPayView(Model model,
        ...
        ProAdVO vo = proAdService.getOneProAd(proAdId);
    ...
    public String redirectAdToProduct(@PathVariable Integer adId) {
        ...
        Integer proId = ad.getProduct().getProId();
